...
const Login = () => {
  ...
  return (
    <div className=" min-h-screen relative bg-black">
      ...
      {/* Login Form Layer (content stays on top) */}
      <div className="flex justify-center items-center min-h-screen relative z-10 px-4 sm:px-6 lg:px-8">
        <form
          onSubmit={handleSubmit}
          className="border border-blue-300 p-6 w-full max-w-sm sm:max-w-md text-white transition-shadow duration-200 ease-in-out 
